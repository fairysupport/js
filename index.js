function ___fairysupport(){
    ...
    this.init = function () {
        ...
        .then((function (fs) {return function () {fs.bindBody();};})(this))
    ...
    this.bindBody = function (){
        ...
        if (body) {
            ...
            document.addEventListener('DOMContentLoaded', () => {
                let loadedBody = document.getElementsByTagName("BODY") ? document.getElementsByTagName("BODY")[0] : null;
                this.bindControllerNest(loadedBody);
            });
        }
