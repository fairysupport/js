...
export default class extends Base {
    ...
    beforeResJsonComponent_click(event) {
        $f.beforeResJsonComponent(this.div1, 'resJson', 'http://localhost/sample/json.php', {"req1": "0val1", "req2" : "val2", 'req3' : ["val3", "val4"], "req4" : {"a" : "val5"}}, () => {console.log('beforeResJsonComponent_click')})
        .send();
    }

    afterResJsonComponent_click(event) {
        $f.afterResJsonComponent(this.div2, 'resJson', 'http://localhost/sample/json.php', {"req1": "1val1", "req2" : "val2", 'req3' : ["val3", "val4"], "req4" : {"a" : "val5"}}, () => {console.log('afterResJsonComponent_click')})
        .send();
    }

    resJsonComponent_click(event) {
        let ajax = $f.resJsonComponent(this.div3, 'resJson', 'http://localhost/sample/json.php', {"req1": "2val1", "req2" : "val2", 'req3' : ["val3", "val4"], "req4" : {"a" : "val5"}}, () => {console.log('resJsonComponent_click')});
