...
export default class extends Base {
    ...
    beforeResJsonComponentByForm_click(event) {
        $f.beforeResJsonComponentByForm(this.div1, 'resJsonByForm', 'http://localhost/sample/jsonByForm.php', this.formObj, () => {console.log('beforeResJsonComponentByForm_click')})
        .send();
    }

    afterResJsonComponentByForm_click(event) {
        $f.afterResJsonComponentByForm(this.div2, 'resJsonByForm', 'http://localhost/sample/jsonByForm.php', this.formObj, () => {console.log('afterResJsonComponentByForm_click')})
        .send();
    }

    resJsonComponentByForm_click(event) {
        let ajax = $f.resJsonComponentByForm(this.div3, 'resJsonByForm', 'http://localhost/sample/jsonByForm.php', this.formObj, () => {console.log('resJsonComponentByForm_click')});
